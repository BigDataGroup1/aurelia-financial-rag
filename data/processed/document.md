...
The real part shows the trend in the absolute price series. When |*p**c*(*t* − 1)| < |*p**c*(*t*)|, that is, when
...
If *p**c*(*t* − 1) = −4 and *p**c*(*t*) = 2, the real part of log(*p**c*(*t*)) − log(*p**c*(*t* − 1)) is negative (line slopes
...
If you convert the continuous returns *r**c*(*t*) = log(*p**c*(*t*)/*p**c*(*t* − 1) ) to simple returns *r**s* = (*p**s*(*t*)/*p**s*(*t* − 1)
